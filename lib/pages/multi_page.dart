...
class _MultiPageState extends State<MultiPage> {
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      if(sp.getBool('yhk') == true){
        checkboxValue = true;
      }else {
        checkboxValue = false;
      }
      if(sp.getBool('wx') == true){
        checkboxValue2 = true;
      }else {
        checkboxValue2 = false;
      }
      if(sp.getBool('zfb') == true){
        checkboxValue3 = true;
      }else {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: ((){
                      sp.setBool('yhk', checkboxValue);
                      sp.setBool('wx', checkboxValue2);
                      sp.setBool('zfb', checkboxValue3);
                      eventBus.fire(DuoXuanBack(index: 1));
                      Navigator.pop(context);
                    }),
                    child: Container(
                      height: ScreenUtil().setHeight(20),
